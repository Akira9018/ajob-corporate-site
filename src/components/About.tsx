...
const About: React.FC = () => {
    const companyInfo = {
        '会社名': 'AJOB合同会社',
        '所在地': '大阪府大阪市北区梅田一丁目1番3号 大阪駅前第3ビル29階',
        '設立': '2023年10月17日',
        '代表者': '代表社員 髙畠光',
                    ...
                    <div className="lg:col-span-3">
                        <ScrollAnimator>
                            ...
                            <p className="text-gray-300 leading-relaxed">
                                目まぐるしく変化する現代において、企業が持続的に成長するためには、テクノロジーの活用と、それを使いこなす人材の力が不可欠です。私たちAJOB合同会社は、お客様一人ひとりの課題に真摯に向き合い、最高の技術とソリューションを提供することで、お客様が描く未来の実現をサポートする、最強のパートナーでありたいと考えています。常識にとらわれず、常に半歩先の未来を見据えたご提案をお約束します。
                            </p>
                        </ScrollAnimator>
                    </div>
